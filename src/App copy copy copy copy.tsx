...
interface Slideshow {
  ...
  message: string;
  created_at: string;
  // Added optional fields used elsewhere in the file
  user_id?: string;
  updated_at?: string;
}
...
export default function App() {
  ...
  // Use different Lottie animations based on theme (FIXED URL double slashes)
  ...
  const createShareableLink = async () => {
    ...
    try {
      ...
      // FIX: match the param your loader reads (?slideshow=)
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-colors">
            ...
            {images.length === 0 ? (
              <>
                ...
                {/* DB-driven helper message for Images section */}
                {imageSectionSubscriptionMessage && (
                  <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                    <p className="text-blue-800 dark:text-blue-300 text-sm">
                      {parseMessageWithIcons(imageSectionSubscriptionMessage)}
                    </p>
                  </div>
                )}
              </>
              ...
              <div>
                {/* Grid of image thumbnails with drag/reorder */}
            ...
            {/* Always-on DB-driven CTA for non-premium users */}
            {!isPremium && (
              <div className="mt-4 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-4 transition-colors">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-colors">
            ...
            {selectedMusic ? (
              ...
              <>
                ...
                {/* Subscription Message for Music (DB-driven) */}
