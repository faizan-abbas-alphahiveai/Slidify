...
export const transitionConfigs: Record<string, TransitionConfig> = {
  ...
  fadeSlow: {
    name: 'Fade (Slow)',
    fullscreen: {
      initial: { opacity: 0, transition: slowTransition },
      animate: { opacity: 1, transition: slowTransition },
      exit: { opacity: 0, transition: slowTransition }
    }
  },
  slide: {
    name: 'Slide',
  ...
  fadeBlackSlow: {
    name: 'Fade through black (Slow)',
    fullscreen: {
      initial: { opacity: 0, scale: 1.05, transition: slowTransition },
      animate: { opacity: 1, scale: 1, transition: slowTransition },
      exit: { opacity: 0, scale: 0.95, transition: slowTransition }
    }
  },
};
